export type Tone = "good" | "warning" | "danger" | "muted" | "unknown" | "info";
...
const states: Record<string, StatePresentation> = {
...
export function presentState(value: unknown): StatePresentation {
...
export function formatBacklog(moduleState: unknown, count: unknown): string {
...
export function apiErrorCode(httpStatus: number, payload: unknown): string {
